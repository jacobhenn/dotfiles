-- jacob's xmonad config file, originally copied from ~/Downloads/xmonad-full-template.hs
--
-- Imports
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    [((m .|. modm, k), windows $ f i)
        | (i, k) <- zip (XMonad.workspaces conf) [xK_exclam, xK_at, xK_numbersign, xK_dollar, xK_percent, xK_asciicircum, xK_ampersand, xK_asterisk, xK_parenleft]
